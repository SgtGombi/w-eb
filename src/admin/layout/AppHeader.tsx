...
//import NotificationDropdown from "@/admin/components/header/NotificationDropdown"; GOMBI: Notif bar adminban most off
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
           ...
           {/* <NotificationDropdown />  */}
            {/* <!-- Notification Menu Area GOMBI: MOST OFF! frontend utan majd lesz notif--> */}
          </div>
          {/* <!-- User Area --> */}
          <UserDropdown /> 

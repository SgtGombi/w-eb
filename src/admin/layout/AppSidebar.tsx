...
//import SidebarWidget from "./SidebarWidget"; GOMBI 2#: navbar alatti informacios resznek
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        ...
        {/* {isExpanded || isHovered || isMobileOpen ? <SidebarWidget /> : null} GOMBI: navbar alatti információs résznek! #2*/} 
      </div>
    </aside>
  );
};
